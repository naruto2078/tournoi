                    ...
                    <div class="col-md-12">
                        <table class="table event-table">
                            ...
                            <tr>
                                ...
                                <td style="width: 50%;"><?= $tournoi->typeTarif; ?></td>
                            </tr>
                            </tbody>
                        </table>
                        <div class="row text-xs-center">
                            ...
                            <button type="button" class="btn btn-warning btn-lg" data-toggle="modal"
                                    data-target="#myModal"
                                    onclick="dialog('<?= $tournoi->typeTarif ?>', '<?= $tournoi->id ?>') "
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Participation au
                                                tournoi <?= $tournoi->nom; ?> </h4>
                                        </div>
                                        <!--Body-->
                                                ...
                                                <form action="" method="post">
                                                    <div class="col-xs-7">
                                                        ...
                                                        <input type="text" name="id"
                                                               value="<?= $tournoi->typeTarif; ?>">
                                                    </div>


                                                    <div class="form-group">
                                                        <div class="col-xs-7">
                                                            <input id="carteBleu" type="radio" name="typeCarte"
                                                                   value="carteBleu"/> Carte Bleu
                                                            <input id="visa" type="radio" name="typeCarte"
                                                                   value="visa"/> Visa
                                                            <input id="mastercard" type="radio" name="typeCarte"
                                                                   value="mastercard"/> Mastercard
                                                            <input id="mastercard" type="radio" name="typeCarte"
                                                                   value="mastercard"/> American Express
                                                    ...
                                                    <div class="f1-buttons">
                                                        <button type="submit" class="btn btn-success">Participer
                                                        </button>
                                                    </div>
