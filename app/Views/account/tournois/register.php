                ...
                <div class="card-block event-card">
                    <div class="col-md-12">
                        ...
                        <div class="row text-xs-center">
                         ...
                         <button type="button" class="btn btn-warning btn-lg" data-toggle="modal"  data-target="#myModal"  onclick="dialog('<?=$tournoi->typeTarif?>', '<?=$tournoi->id?>') " style="text-transform: none">
                            Participer 
                        </button>
                                ...
                                <div class="row multistep">
                                    <form action="" method="post">
                                       <div class="col-xs-7">
                                        ...
                                        <input type="text" name="id" value="<?= $tournoi->typeTarif; ?>">
                                    </div>
