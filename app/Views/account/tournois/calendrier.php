...
<div class="row">
            ...
            <?php for ($i = 2; $i <= $numero; $i++): ?>
             ...
             <div class="tab-content">
                ...
                <div class="tab-pane active" id="panel1" role="tabpanel">
                    ...
                    <button type="button" class="btn btn-info" name="buttonPoule$i"  onclick=dialogPoule('<?= $all_poule_id['poule 1'][$_GET['tournoi_id']];?>')>Presicer Nombre de Set et Nombre de point pour la Poule 1
                    </button>
                <?php endfor; ?>
               ...
               <table class="table event-table card-text">
                    ...
                    <tr>
                        ...
                        <td style="width: 50%;">12 </td>
                                ...
                                <div>
                                    <button type="button" class="btn btn-info" name="button$j" onclick=dialog('<?= $all_teams[$matches[$i]->team_id_home]; ?>','<?= $all_teams[$matches[$i]->team_id_away]; ?>','<?= $match->id ?>','<?= $all_nb_set['poule 1'][$_GET['tournoi_id']];?>') >Ajouter le score
                                    </button>
                                    <button type="button" class="btn btn-info" name="button$j" onclick=dialog2('<?= $all_teams[$matches[$i]->team_id_home]; ?>','<?= $all_teams[$matches[$i]->team_id_away]; ?>','<?= $match->id ?>','<?= $all_nb_set['poule 1'][$_GET['tournoi_id']];?>') >Modifier le score
                                    </button>
                                </div>
    ...
    <?php for ($i = 2; $i <= $numero; $i++): ?>
        ...
        <div class="tab-pane" id="panel<?= $i; ?>" role="tabpanel">
            <button type="button" class="btn btn-info" name="buttonPoule$i"  onclick=dialogPoule('<?= $all_poule_id["poule $i"][$_GET['tournoi_id']];?>')>Presicer Nombre de Set et Nombre de point pour la Poule<?=$_GET['tournoi_id'];?>
            </button>
            <table class="table table-bordered">
                <thead>
                    <tr>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="card  text-xs-center ">
                            ...
                            <div class="card-footer">
                                ...
                                <div>
                                    <button type="button" class="btn btn-info" name="button$jbis" onclick=dialog('<?= $all_teams[$matches[$j]->team_id_home]; ?>','<?= $all_teams[$matches[$j]->team_id_away]; ?>','<?= $match->id ?>','<?= $all_nb_set["poule $i"][$_GET['tournoi_id']];?>') >Ajouter le score
                                    </button>
                                    <button type="button" class="btn btn-info" name="button$jbisM" onclick=dialog2('<?= $all_teams[$matches[$j]->team_id_home]; ?>','<?= $all_teams[$matches[$j]->team_id_away]; ?>','<?= $match->id ?>','<?= $all_nb_set["poule $i"][$_GET['tournoi_id']];?>') >Modifier le score
                                    </button>
