                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <?php for ($k = 1; $k <= $nb_set_score; $k++): ?>
                                                        <td ><?= isset($all_set_by_team_match[$match->id][$matches[$i]->team_id_home][$k])?$all_set_by_team_match[$match->id][$matches[$i]->team_id_home][$k] : "NR"; ?></td>
                                                    <?php endfor; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php for ($k = 1; $k <= $nb_set_score; $k++): ?>
                                                        <td ><?= isset($all_set_by_team_match[$match->id][$matches[$i]->team_id_away][$k])?$all_set_by_team_match[$match->id][$matches[$i]->team_id_away][$k] : "NR"; ?></td>
                                                    <?php endfor; ?>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table event-table card-text">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <?php for ($k = 1; $k <= $nb_set_score; $k++): ?>
                                                        <td ><?= isset($all_set_by_team_match[$match->id][$matches[$j]->team_id_home][$k])?$all_set_by_team_match[$match->id][$matches[$j]->team_id_home][$k] : "NR"; ?></td>
                                                    <?php endfor; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php for ($k = 1; $k <= $nb_set_score; $k++): ?>
                                                        <td ><?= isset($all_set_by_team_match[$match->id][$matches[$j]->team_id_away][$k])?$all_set_by_team_match[$match->id][$matches[$j]->team_id_away][$k] : "NR"; ?></td>
                                                    <?php endfor; ?>
                                                </tr>
                                            </tbody>
                                        </table>
